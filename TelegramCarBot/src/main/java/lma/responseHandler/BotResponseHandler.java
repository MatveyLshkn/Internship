...
public class BotResponseHandler {
    ...
    public SendMessage handleSubscribeCommand(Long chatId) {
        return getBrandsAsInlineKeyboardInSendMessage(chatId);
    }
    ...
    public SendMessage handleUnsubscribeCommand(Long userId, Long modelId) {
        return getSubscriptionListInSendMessage(userId, modelId, true);
    }
